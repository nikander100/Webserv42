...
inline std::string ToString(Code code)
{
	...
	static const std::unordered_map<Code, std::string> statusMap = {
		...
		{Code::SWITCHING_PROTOCOLS, "Switching Protocol"},
		{Code::OK, "OK"},
		...
		{Code::MULTIPLE_CHOICES, "Multiple Choice"},
		{Code::MOVED_PERMANENTLY, "Moved Permanently"},
		{Code::MOVED_TEMPORARILY, "Moved Temporarily"},
		{Code::FOUND, "Found"},
		...
		{Code::RANGE_NOT_SATISFIABLE, "Requested Range Not Satisfiable"},
