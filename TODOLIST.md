	errorpages check how to fix css file getting when going topaage directly? appends double path /error_pages/error_pages when getting the css file on direct access.
